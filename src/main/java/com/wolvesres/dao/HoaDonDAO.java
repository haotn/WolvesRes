...
public class HoaDonDAO implements WolvesResDAO<ModelHoaDon, String> {
    ...
    public List<ModelHoaDon> selectBySQL(String sql, Object... Entity) {
        ...
        try {
            ...
            try {
                ...
                while (result.next()) {
                    // Đối tượng KHO
                    ModelHoaDon K = new ModelHoaDon(result.getString(1), result.getString(2), result.getString(3), result.getString(4), result.getString(5), result.getFloat(6), result.getFloat(7), result.getBoolean(8));
    ...
    public void insert(ModelHoaDon Entity) {
        try {
            ...
            XJdbc.update(sql, Entity.getMaHD(), Entity.getNguoiXuat(), Entity.getMaBan(), Entity.getMaVoucher(), Entity.getThue(), Entity.getTienHang(), Entity.isTrangThai());
