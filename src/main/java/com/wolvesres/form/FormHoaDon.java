...
public class FormHoaDon extends javax.swing.JPanel {
    ...
    public FormHoaDon(JFrame frame) {
        ...
        Icon iconCancel = IconFontSwing.buildIcon(GoogleMaterialDesignIcons.REMOVE_SHOPPING_CART, 32, new Color(0, 199, 135));
    ...
    public void HuyHoaDon(int select) {
        ...
        if (select >= 0) {
            ...
            if (ROptionDialog.showConfirm(frame, "Xác nhận", "Bạn có muôn hủy Hoá đơn " + emp.getMaHD() + " không?", ROptionDialog.WARNING, Color.yellow, Color.black)) {
                list.set(select, emp);
                dao.update(emp, emp.getMaHD());
                fillTable();
            }
        } else {
            ROptionDialog.showAlert(frame, "Thông báo", "Bạn chưa chọn hóa đơn", ROptionDialog.WARNING, Color.red, Color.black);
        }
    }
...
//
    ...
    private void initComponents() {
        ...
        tblHoaDon.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã HD", "Người Xuất", "Ngày Xuất", "Mã Bàn", "Mã Voucher", "Thuế", "Tiền Hàng", "Trạng Thái"
            }
        ) {
