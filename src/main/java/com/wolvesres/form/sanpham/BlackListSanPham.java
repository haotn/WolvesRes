...
public class BlackListSanPham extends javax.swing.JDialog {
    ...
    List<ModelSanPham> listSP = new ArrayList<>();
    ...
    EventActionBlackList<ModelSanPham> eventAction = new EventActionBlackList<ModelSanPham>() {
        ...
        public void update(ModelSanPham sanpham) {
            if (ROptionDialog.showConfirm(frame,"Xác nhận", "Bạn có chắc chắn muốn đưa ra khỏi danh sách đen không", ROptionDialog.WARNING, Color.yellow, Color.black)) {
                isChangeData = true;
                sanpham.setTrangThai(true);
                updateStatus(sanpham);
    ...
    public void LoadToBlack() {
        listSP.clear();
        for (ModelSanPham sp : formSP.getList()) {
    ...
    public void updateStatus(ModelSanPham sp) {
        daoSP.update(sp, sp.getMaSP());
        for (int i = 0; i < formSP.getList().size(); i++) {
            if (formSP.getList().get(i).getMaSP().endsWith(sp.getMaSP())) {
                formSP.getList().set(i, sp);
            }
        }
        fillToTable();
    }
    ...
    private void initComponents() {
        ...
        tblBlackListSP.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BlackListSanPham.class
