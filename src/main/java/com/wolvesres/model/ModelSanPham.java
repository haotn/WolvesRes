...
public class ModelSanPham {
    ...
    public ModelSanPham(String maSP, String tenSP, float giaBan, String maDanhMuc, String pathAnh, int maDVT, boolean trangThai) {
        this.maSP = maSP;
        this.tenSP = tenSP;
        this.giaBan = giaBan;
    ...
    public ModelSanPham(Icon icon, String maSP, String tenSP, float giaBan, String maDanhMuc, String pathAnh, int maDVT, boolean trangThai) {
        this.icon = icon;
        this.maSP = maSP;
        this.tenSP = tenSP;
        this.giaBan = giaBan;
    ...
    public Object[] toRowTable(EventAction event, List<ModelDanhMuc> listDanhMucs) {
        ...
        for (int i = 0; i < listDanhMucs.size(); i++) {
            if (getMaDanhMuc().equals(listDanhMucs.get(i).getMaDanhMuc())) {
                row = new Object[]{new ModelProfile(getIcon(), getTenSP(), this), String.valueOf(listDanhMucs.get(i).getTenDanhMuc()), XFormatMoney.formatMoney(getGiaBan()), String.valueOf(listDanhMucs.get(i).isMatHang() ? "Mặt hàng" : "Món ăn"), new ModelAction(this, event)};
            }
        }
        return row;
    }
    ...
    public Object[] toRowTableBlackList(EventActionBlackList event, List<ModelDanhMuc> listDanhMucs) {
        ...
        for (int i = 0; i < listDanhMucs.size(); i++) {
            if (getMaDanhMuc().equals(listDanhMucs.get(i).getMaDanhMuc())) {
                row = new Object[]{new ModelProfile(getIcon(), getTenSP(), this), String.valueOf(listDanhMucs.get(i).getTenDanhMuc()), XFormatMoney.formatMoney(getGiaBan()), String.valueOf(listDanhMucs.get(i).isMatHang() ? "Mặt hàng" : "Món ăn"), new ModelActionBlackList(icon, this, event)};
            }
        }
        return row;
    }
    ...
    public Object[] toRowTableMINV(List<ModelDanhMuc> listDanhMucs) {
        ...
        for (int i = 0; i < listDanhMucs.size(); i++) {
            if (getMaDanhMuc().equals(listDanhMucs.get(i).getMaDanhMuc())) {
                row = new Object[]{new ModelProfile(getIcon(), getTenSP(), this), listDanhMucs.get(i).getTenDanhMuc(), XFormatMoney.formatMoney(getGiaBan()), listDanhMucs.get(i).isMatHang() ? "Mặt hàng" : "Món ăn"};
            }
        }
        return row;
    }
    ...
    public Object[] toRowTable(List<ModelDanhMuc> listDanhMucs) {
        ...
        for (int i = 0; i < listDanhMucs.size(); i++) {
            if (getMaDanhMuc().equals(listDanhMucs.get(i).getMaDanhMuc())) {
                row = new Object[]{new ModelProfile(getIcon(), getTenSP(), this), listDanhMucs.get(i).getTenDanhMuc(), getGiaBan()};
            }
        }
        return row;
    }
...
/////////////////////////////////////////////////////////
    ...
    public Object[] toRowNhapKho(List<ModelDanhMuc> listDanhMucs) {
        ...
        for (int i = 0; i < listDanhMucs.size(); i++) {
            if (getMaDanhMuc().equals(listDanhMucs.get(i).getMaDanhMuc())) {
                row = new Object[]{new ModelProfile(getIcon(), getTenSP(), this), listDanhMucs.get(i).getTenDanhMuc(), XFormatMoney.formatMoney(getGiaBan())};
            }
        }
        return row;
    }

    public Object[] toRowTableBanHang(EventActionBlackList event, List<ModelKho> listKhos, List<ModelDanhMuc> listDanhMucs) {
        Object[] row = new Object[]{};
        for (int i = 0; i < listDanhMucs.size(); i++) {
            if (getMaDanhMuc().equals(listDanhMucs.get(i).getMaDanhMuc())) {
                if (listDanhMucs.get(i).isMatHang()) {
                    for (ModelKho kho : listKhos) {
                        if (getMaSP().equals(kho.getMaSP())) {
                            if (kho.getSoLuong() > 0) {
                                row = new Object[]{new ModelProfile(getIcon(), getTenSP(), this), listDanhMucs.get(i).getTenDanhMuc(), XFormatMoney.formatMoney(getGiaBan()), kho.getSoLuong(), new ModelActionBlackList(new ImageIcon(getClass().getResource("/com/wolvesres/icon/addToListOrder.png")), this, event)};
                            }
                        }
                    }
                } else {
                    row = new Object[]{new ModelProfile(getIcon(), getTenSP(), this), listDanhMucs.get(i).getTenDanhMuc(), XFormatMoney.formatMoney(getGiaBan()), null, new ModelActionBlackList(new ImageIcon(getClass().getResource("/com/wolvesres/icon/addToListOrder.png")), this, event)};
                }
            }
        }
        return row;
